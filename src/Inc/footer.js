...
import travelimg from "../assets/images/icon/travel.png"
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="footer-text">
                            <p>Copy@ 2023 <span style={{color: "#F7921E"}}>
                            MTS Solutions</span>, All Right Reserved</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
