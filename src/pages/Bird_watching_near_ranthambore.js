...
// import placeimg8 from "../assets/images/place/single-place-8.jpg"
...
const Bird_watching_near_ranthambore = () => {
    return (
<>
<HeaderTop></HeaderTop>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="page-banner-content text-center text-white">
                            <h1 class="page-title">Bird watching near ranthambore</h1>
                            <ul class="breadcrumb-link text-white">
                                <li><a href="index.html">Home</a></li>
                                <li class="active">Bird watching near ranthambore</li>
                            </ul>
                        </div>
                    </div>
                </div>
...
export default Bird_watching_near_ranthambore;