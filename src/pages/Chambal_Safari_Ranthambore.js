...
const Chambal_Safari_Ranthambore = () => {
    return (
<>
<HeaderTop></HeaderTop>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="page-banner-content text-center text-white">
                            <h1 class="page-title">Chambal Safari Ranthambore</h1>
                            <ul class="breadcrumb-link text-white">
                                <li><a href="index.html">Home</a></li>
                                <li class="active">Chambal Safari Ranthambore</li>
                            </ul>
                        </div>
                    </div>
                </div>
...
export default Chambal_Safari_Ranthambore;